<div class="home">
  <div class="presentation">
    ...
    <img class="pres_icon" src="./View/Assets/icon/carpooling.svg" alt="logo de EcoRide"><br>
    <p>Chez EcoRide nous prônons une approche écologique et nous récompensons les transports en véhicule électrique.</p>
    <img class="pres_icon" src="./View/Assets/icon/electric-car.svg" 
    ...
    <img class="pres_img" src="./View/Assets/img/pierre-borthiry-peiobty.jpg" alt="image">
  </div>
</div>
